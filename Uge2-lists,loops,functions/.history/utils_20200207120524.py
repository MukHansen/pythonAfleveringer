...
if __name__ == "__main__":
    ...
    parser.add_argument("--files_in_folder", nargs='', help="Write filenames to file")
    parser.add_argument("--all_files_in_folder_recursiv", nargs='', help="Write filenames and folders to file")
